                    ...
                    <form method="POST" action="appointment_process.php" >
                        <div class="row g-3">
                            ...
                            <div class="col-12 col-md-12" id="address" data-target-input="nearest">
                                 <!-- <input  type="text"  id="addressbar" class="form-control bg-light border-0" name="address" style="height: 55px; resize:none;" placeholder="Address " ></input> -->
                                 <textarea  type="text"  id="addressbar" class="form-control bg-light border-0" name="address" style="height: 55px; resize:none;" placeholder="Address " ></textarea>
                            </div>
                            ...
                            <div class="col-12 col-sm-6">
                                <select class="form-select bg-light border-0" name="blood_groups" style="height: 55px;" >
                            ...
                            <div class="col-12 col-sm-6">
                                <select class="form-select bg-light border-0" name="specialists" style="height: 55px;">
                            ...
                            <div class="col-12 col-sm-6">
                                <select class="form-select bg-light border-0" name="doctor_names" style="height: 55px;">
                            ...
                            <div class="col-12">
                                <button class="btn btn-primary w-100 py-3" type="submit"  name="submit_btn" >Make Appointment</button>
                            </div>
                        </div>
                    </form>
                </div>
